...
foreach(_cmake_expected_target IN ITEMS kfr_dsp_neon64 kfr_dsp kfr_io kfr_dft_neon64 kfr_dft kfr)
...
set_target_properties(kfr_dsp PROPERTIES
  INTERFACE_LINK_LIBRARIES "kfr_dsp_neon64"
  INTERFACE_LINK_OPTIONS "LINKER:-force_load,\$<TARGET_FILE:kfr_dsp_neon64>"
)
...
set_target_properties(kfr_dft PROPERTIES
  INTERFACE_LINK_LIBRARIES "kfr_dft_neon64"
  INTERFACE_LINK_OPTIONS "LINKER:-force_load,\$<TARGET_FILE:kfr_dft_neon64>"
)
